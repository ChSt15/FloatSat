...
void ORPE_LEDControl::run() {
    ...
    */
    this->setupLED(0, LEDPIN_1, 0b01011110, 0);
	this->setupLED(1, LEDPIN_2, 0b10101111, 28);
	this->setupLED(2, LEDPIN_3, 0b11010111, 16);
	this->setupLED(3, LEDPIN_4, 0b01011011, 12);
	this->setupLED(4, LEDPIN_5, 0b11011010, 20);
	this->setupLED(5, LEDPIN_6, 0b11010000, 4);
	this->setupLED(6, LEDPIN_7, 0b10010110, 8);
	this->setupLED(7, LEDPIN_8, 0b11110101, 24);
    this->setupLED(8, LEDPIN_9, 0b11011010, 20);
	this->setupLED(9, LEDPIN_10, 0b11010000, 4);
	this->setupLED(10, LEDPIN_11, 0b10010110, 8);
	this->setupLED(11, LEDPIN_12, 0b11110101, 24);
